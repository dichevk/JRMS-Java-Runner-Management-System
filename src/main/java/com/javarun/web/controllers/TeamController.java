...
public class TeamController {
    ...
    @PostMapping
    public ResponseEntity<TeamDto> createTeam(TeamDto teamDto, Long coachId, Long historyId, List<EventDto>events, List<RunnerDto> runners) throws InvalidIdentifierException, EntityAlreadyExistsException{
    ...
    @PutMapping("/{teamId}")
    public ResponseEntity<TeamDto> updateTeam(TeamDto teamDto, @PathVariable Long teamId) throws EntityNotFoundException, ConstraintsViolationException, InvalidIdentifierException{
